...
cd $ENGINE_PATH_FULL
sh Engine/Build/BatchFiles/Mac/Build.sh ShaderCompileWorker Mac Development
sh Engine/Build/BatchFiles/Mac/Build.sh UnrealLightmass Mac Development
sh Engine/Build/BatchFiles/Mac/Build.sh UnrealPak Mac Development
